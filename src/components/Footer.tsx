...
export default function Footer() {
    return (
        <AnimatePresence>
            <motion.div className="bg-footer w-full h-100">
                <motion.main className="w-full h-full flex justify-between">
                    <motion.div className="flex flex-col items-center justify-center w-200 h-120">
                    ...
                    <motion.div className="flex justify-between w-full ml-20 mr-20 h-100 pt-20 border-b-white border-b-3">
                        <motion.nav className="flex flex-col justify-center w-50">
                ...
                <motion.aside className="bg-footer flex justify-end items-center w-full h-30">
                    <motion.div className="flex justify-center items-center w-250 h-full mr-20">
                        ...
                        <motion.nav className="text-primary-foreground flex justify-end w-100">
                            <Link href="/" className="mr-5"><Linkedin /></Link>
                            <Link href="/" className="mr-5"><Instagram /></Link>
